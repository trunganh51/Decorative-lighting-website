    ...
    <head>
        ...
        <style>
            ...
            *{
            ...
            /* === POPUP (Modal + SVG) – giữ đúng cấu trúc hiện tại === */
            .success-form{
                position:fixed;
                inset:0;
                display:none;
        ...
        <div class="container">
            ...
            <div class="promo-section" style="margin-bottom:25px; display:flex; gap:20px; flex-wrap:wrap; justify-content:center;">
                ...
                <div style="flex:1; min-width:200px; background:var(--chip-bg); padding:20px; border-radius:14px; text-align:center; box-shadow:0 6px 16px var(--shadow);">
                    <h4 style="margin-bottom:10px;">🚚 Miễn phí giao hàng</h4>
                    <p>Cho đơn hàng từ 1.000.000₫ trở lên</p>
                </div>

                <!-- Warranty -->
                <div style="flex:1; min-width:200px; background:var(--chip-bg); padding:20px; border-radius:14px; text-align:center; box-shadow:0 6px 16px var(--shadow);">
                    <h4 style="margin-bottom:10px;">🛠 Bảo hành</h4>
                    <p>Bảo hành sản phẩm 12 tháng, yên tâm sử dụng</p>
                </div>

                <!-- Return -->
                <div style="flex:1; min-width:200px; background:var(--chip-bg); padding:20px; border-radius:14px; text-align:center; box-shadow:0 6px 16px var(--shadow);">
                    <h4 style="margin-bottom:10px;">🔄 Đổi trả dễ dàng</h4>
